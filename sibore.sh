...
# Ask for server name (sni)
read -p "Enter server name/SNI (default: www.speedtest.net): " server_name
server_name=${server_name:-www.speedtest.net}
...
# Generate the link
    ...
    server_link="vless://$uuid@$server_ip:$listen_port?encryption=none&flow=xtls-rprx-vision&security=reality&sni=$server_name&fp=chrome&pbk=$public_key&sid=$short_id&type=tcp&headerType=none#Masoud"
